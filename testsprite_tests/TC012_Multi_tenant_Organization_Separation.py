...
async def run_test():
    ...
    try:
        ...
        # -> Click on Login to start authentication as User A.
        ...
        # -> Input User A email and password, then submit login form.
        frame = context.pages[-1]
        # Input User A email for login.
        ...
        frame = context.pages[-1]
        # Input User A password for login.
        ...
        # -> Navigate to Documents page to upload documents for Organization A.
        frame = context.pages[-1]
        # Click Documents to go to document management page for upload.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Access Granted to Organization A Documents').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError('Test failed: User B was able to access documents from Organization A, violating access control policies.')
