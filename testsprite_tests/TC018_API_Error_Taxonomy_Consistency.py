...
async def run_test():
    ...
    try:
        ...
        # -> Trigger known error scenarios on upload API by navigating to Documents and attempting invalid upload.
        frame = context.pages[-1]
        # Click Documents link to go to documents management page
        ...
        try:
            ...
            raise AssertionError("Test case failed: API endpoints for upload, embedding, and search did not return consistent error codes and messages as per the defined error taxonomy.")
